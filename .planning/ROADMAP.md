...
- [x] 02-01-PLAN.md: Implement and test windowed FFT, normalization, log mapping, smoothing, and snapshot model.
...
- [x] 02-03-PLAN.md: Integrate transparent VST3 buses/processing and efficient web spectrum renderer.
...
- [x] 03-03: Integrate standalone source controls, persistence, diagnostics, and device test matrix.
...
- [x] 04-01: Define logical infrastructure manifest, portable Wrangler config, generated-state boundary, and token scopes.

**Wave 2** *(completed)*

- [x] 04-02: Build idempotent bootstrap, secret, migration, deploy, verify, and teardown command surface.
- [x] 04-03: Implement D1 schema/repositories and exact-raw-body Lemon webhook verification/idempotency.

**Wave 3** *(completed)*

- [x] 04-04: Rehearse fresh-account provisioning and document Lemon webhook registration handoff.
